...
<html>
  ...
  <body>
    ...
    <div id="page" class="container">
      <div class="row">
        <div class="span12">
          <p class="lead">Please assign field mappings for content type <s:property value="contentTypeMapping.contentTypeInformation.path"/> and XPath <s:property value="contentTypeMapping.dataDefinitionBlockXPath"/>.</p>
          ...
          <form action="/AssignFields" method="POST">
            <input type="hidden" name="ctIndex" value="<s:property value="ctIndex"/>"/>
            <div class="row">             
              <div class="span3">
                      ...
                      <div class="controls">
                        <select name="cascadeFieldNames" id="cascadeFieldNames" class="input-block-level">
                          <optgroup label="-Metadata-">
                            <s:iterator value="contentTypeMapping.contentTypeInformation.metadataFields.values()">                        
                          ...
                          <optgroup label="-Data Definition-">
                            <s:iterator value="contentTypeMapping.contentTypeInformation.dataDefinitionFields.values()">                        
    ...
    <script type="text/javascript">
      $(function() {
        ...
        <s:iterator value="contentTypeMapping.fieldMapping.entrySet()">
        ...
        <s:iterator value="contentTypeMapping.staticValueMapping.entrySet()">
